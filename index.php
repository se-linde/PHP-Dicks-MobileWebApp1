...
<h1>Dick's Food Calculator</h1>
    ...
    <section class="page">
      <ul class="accordion">
        <li>
          <button class="accordion-control">Burgers and Fries</button>
        ...
        <li>
          <button class="accordion-control">Milk Shakes and Drinks</button>
          <div class="accordion-panel">
        ...
        <li>
          <button class="accordion-control">Sodas</button>
          <div class="accordion-panel">
          ...
          <li>
          <button class="accordion-control">Old Fashioned Ice Cream</button>
          <div class="accordion-panel">
          ...
          <li>
          <button class="accordion-control">Condiments</button>
          <div class="accordion-panel">
